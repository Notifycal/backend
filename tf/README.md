...
| <a name="input_lambda_logging"></a> [lambda\_logging](#input\_lambda\_logging) | Lambda logging configuration. Log retention default value matches what the privacy policy states. | <pre>object({<br/>    retention_in_days = optional(number, 180)<br/>  })</pre> | <pre>{<br/>  "retention_in_days": 180<br/>}</pre> | no |
