...
| <a name="input_observability"></a> [observability](#input\_observability) | n/a | <pre>optional(object({<br/>    slack_webhook_url = string<br/>    slack_channel     = string<br/>  }))</pre> | n/a | yes |
